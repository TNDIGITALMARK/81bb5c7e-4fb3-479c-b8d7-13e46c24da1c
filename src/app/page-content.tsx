...
import { InteractiveCard } from '@/components/gamification/interactive-card'
import { useState } from 'react'

export default function PageContent() {
  const { state, unlockAchievement, addXP } = useGamification()
  const [visitedGames, setVisitedGames] = useState<Set<string>>(new Set())

  const handleGameCardClick = (gameId: string) => {
    const newVisited = new Set(visitedGames)
    newVisited.add(gameId)
    setVisitedGames(newVisited)
    ...
    <div className="min-h-screen bg-[hsl(var(--background))]">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[hsl(var(--background))] border-b border-[hsl(var(--border))] backdrop-blur-sm bg-opacity-90">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/#about" className="text-sm text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition uppercase hover-glow" style={{fontFamily: 'Orbitron, sans-serif', letterSpacing: '0.05em'}}>
              About
            </Link>
            <Link href="/#projects" className="text-sm text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition uppercase hover-glow" style={{fontFamily: 'Orbitron, sans-serif', letterSpacing: '0.05em'}}>
              Apps & Games
            </Link>
            <Link href="/community" className="text-sm text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition uppercase hover-glow" style={{fontFamily: 'Orbitron, sans-serif', letterSpacing: '0.05em'}}>
              Community
            </Link>
            <Link
              href="/community"
              onClick={handleCommunityClick}
              className="px-6 py-2 bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] rounded-lg hover:shadow-cyan transition font-semibold text-sm uppercase glow-pulse"
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block mb-6 badge-container bounce-in">
              ⚡ INDIE GAME STUDIO
            </div>
            ...
            <p className="text-lg md:text-xl text-[hsl(var(--muted-foreground))] max-w-3xl mx-auto mb-4 leading-relaxed" style={{fontFamily: 'Inter, sans-serif', fontWeight: 400}}>
            ...
            <p className="text-sm md:text-base text-[hsl(var(--accent))] max-w-2xl mx-auto mb-12 font-semibold italic" style={{fontFamily: 'Orbitron, sans-serif'}}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <InteractiveCard>
                <Link
                  href="/flirtdeck"
                  className="block px-10 py-5 bg-gradient-fun text-white rounded-xl hover:shadow-blue-lg hover-lift transition-all duration-300 font-bold text-lg uppercase relative overflow-hidden group"
              ...
              <InteractiveCard>
                <Link
                  href="/community"
                  onClick={handleCommunityClick}
                  className="block px-10 py-5 border-2 border-[hsl(var(--primary))] text-[hsl(var(--primary))] rounded-xl hover:bg-[hsl(var(--primary))] hover:text-white hover:shadow-blue hover-lift transition-all duration-300 font-bold text-lg uppercase"
                  style={{fontFamily: 'Orbitron, sans-serif'}}
                >
                  Join Community
                </Link>
          ...
          <div id="flirtdeck" className="mb-20">
            <div className="text-center mb-8">
              <div className="inline-block badge-container mb-4">
                ✨ FEATURED PROJECT
              </div>
          ...
          <div className="mb-20 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <InteractiveCard className="relative group text-center p-6 md:p-8 rounded-2xl bg-gradient-to-br from-[hsl(var(--card))] to-[hsl(var(--background))] border-2 border-[hsl(var(--border))] hover:border-[hsl(var(--primary))] transition-all duration-300 hover-lift overflow-hidden">
            ...
            <InteractiveCard className="relative group text-center p-6 md:p-8 rounded-2xl bg-gradient-to-br from-[hsl(var(--card))] to-[hsl(var(--background))] border-2 border-[hsl(var(--border))] hover:border-[hsl(var(--secondary))] transition-all duration-300 hover-lift overflow-hidden">
            ...
            <InteractiveCard className="relative group text-center p-6 md:p-8 rounded-2xl bg-gradient-to-br from-[hsl(var(--card))] to-[hsl(var(--background))] border-2 border-[hsl(var(--border))] hover:border-[hsl(var(--accent))] transition-all duration-300 hover-lift overflow-hidden">
          ...
          <div id="projects">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <InteractiveCard
                className="group rounded-xl overflow-hidden border-glow hover:shadow-blue-lg hover-lift transition-all duration-300 bg-[hsl(var(--card))]"
                onClick={() => handleGameCardClick('silkbound')}
              >
              ...
              <InteractiveCard
                className="group rounded-xl overflow-hidden border-glow-purple hover:shadow-purple-lg hover-lift transition-all duration-300 bg-[hsl(var(--card))]"
                onClick={() => handleGameCardClick('harvest')}
              >
              ...
              <InteractiveCard
                className="group rounded-xl overflow-hidden border-glow-cyan hover:shadow-cyan-lg hover-lift transition-all duration-300 bg-[hsl(var(--card))]"
                onClick={() => handleGameCardClick('suspect')}
              >
      ...
      <section id="about" className="py-24 px-6 relative overflow-hidden border-t border-[hsl(var(--border))]">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          <div className="inline-flex items-center gap-2 mb-6 badge-container">
            <span>🚀</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <InteractiveCard>
              <Link
                href="/community"
                onClick={handleCommunityClick}
                className="block relative group px-10 py-5 bg-gradient-fun text-white rounded-xl hover:shadow-blue-lg hover-lift transition-all duration-300 font-bold text-lg uppercase overflow-hidden"
                style={{fontFamily: 'Orbitron, sans-serif'}}
              >
            ...
            <InteractiveCard>
              <Link
                href="/#projects"
                className="block px-10 py-5 border-2 border-[hsl(var(--muted-foreground)/0.3)] text-[hsl(var(--muted-foreground))] rounded-xl hover:border-[hsl(var(--primary))] hover:text-[hsl(var(--primary))] transition-all duration-300 font-bold text-lg uppercase"
                style={{fontFamily: 'Orbitron, sans-serif'}}
              >
                Explore Games
              </Link>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-8">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <Link href="/#about" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition font-medium hover-glow" style={{fontFamily: 'Inter, sans-serif'}}>
                About
              </Link>
              <Link href="/#projects" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition font-medium hover-glow" style={{fontFamily: 'Inter, sans-serif'}}>
                Apps & Games
              </Link>
              <Link href="/flirtdeck" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition font-medium hover-glow" style={{fontFamily: 'Inter, sans-serif'}}>
                FlirtDeck
              </Link>
              <Link href="/community" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary))] transition font-medium hover-glow" style={{fontFamily: 'Inter, sans-serif'}}>
                Community
              </Link>
            </div>
          ...
          <div className="pt-8 border-t border-[hsl(var(--border))] flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-[hsl(var(--muted-foreground))]">
            ...
            <div className="flex gap-6">
              <a href="#" className="hover:text-[hsl(var(--primary))] transition hover-glow" style={{fontFamily: 'Inter, sans-serif'}}>Privacy</a>
              <a href="#" className="hover:text-[hsl(var(--primary))] transition hover-glow" style={{fontFamily: 'Inter, sans-serif'}}>Terms</a>
              <a href="#" className="hover:text-[hsl(var(--primary))] transition hover-glow" style={{fontFamily: 'Inter, sans-serif'}}>Contact</a>
            </div>
          </div>
        </div>
      </footer>
